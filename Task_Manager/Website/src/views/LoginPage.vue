<template>
    <body class="login-page">
      <div class="login-container">
        ...
        <h4 class="login_text mb-3">Login to continue</h4>
        ...
        <p class="mt-4">
          <a href="#" class="text-decoration-none">Can't log in?</a> •
...
<!-- scoped là một từ khóa dùng trong <style> để giới hạn phạm 
  vi của CSS chỉ trong component hiện tại, giúp tránh ảnh hưởng đến các component khác. -->
<style scoped>
