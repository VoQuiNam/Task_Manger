<template>
    <div class="register-container">
        ...
        <p class="mt-4">
            <router-link to="/login" class="text-decoration-none">Have already account?</router-link>
        </p>
        <p class="text-muted small">One account for Jira, Confluence, Trello, and more.</p>
