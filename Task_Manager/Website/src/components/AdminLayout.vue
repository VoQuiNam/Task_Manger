<template>
    <div class="d-flex flex-column flex-shrink-0 p-4 bg-light" style="width: 280px; min-height: 100vh;">
        <a href="/dashboard" class="d-flex align-items-center mb-4 text-dark text-decoration-none">
            <svg class="bi me-3 w-280" viewBox="0 0 190 32" height="32" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                <defs>
   ...
   export default {
    data() {
        return {
            activeIndex: 0,
            menuItems: [
                { icon: ['fas', 'gauge'], label: "Dashboard" },
                { icon: ['fas', 'user'], label: "User" },
                { icon: ['fas', 'user-cog'], label: "Role" }
            ]
        };
    },
    mounted() {
